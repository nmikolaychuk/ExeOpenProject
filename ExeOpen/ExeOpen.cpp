...
// ExeOpen.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CExeOpenApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CExeOpenApp

CExeOpenApp::CExeOpenApp()
{
...
// Единственный объект CExeOpenApp

CExeOpenApp theApp;


// инициализация CExeOpenApp

BOOL CExeOpenApp::InitInstance()
{
